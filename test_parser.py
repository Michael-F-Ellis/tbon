...
def test_numeric_accidentals():
    evaluate("K=C 1♭1 𝄫1♭1 ♮1♯1 𝄪1♯1 | 1 - - - |",
             [(60, 0.0, 0.50), (59, 0.50, 1.0), (58, 1.0, 1.50),
              (59, 1.50, 2.0), (60, 2.0, 2.50), (61, 2.50, 3.0),
              (62, 3.0, 3.50), (61, 3.50, 4.0), (60, 4.0, 8.0)],
             numeric=True)
    evaluate("K=c 1♭1 𝄫1♭1 ♮1♯1 𝄪1♯1 | 1 - - - |",
             [(60, 0.0, 0.50), (59, 0.50, 1.0), (58, 1.0, 1.50),
              ...
              (62, 3.0, 3.50), (61, 3.50, 4.0), (60, 4.0, 8.0)],
             numeric=True)
    evaluate("K=B 1♭1 𝄫1♭1 ♮1♯1 𝄪1♯1 | 1 - - - |",
             [(59, 0.0, 0.50), (58, 0.50, 1.0), (57, 1.0, 1.50),
              (58, 1.50, 2.0), (59, 2.0, 2.50), (60, 2.50, 3.0),
              (61, 3.0, 3.50), (60, 3.50, 4.0), (59, 4.0, 8.0)],
             numeric=True)
    evaluate("K=b 1♭1 𝄫1♭1 ♮1♯1 𝄪1♯1 | 1 - - - |",
             [(59, 0.0, 0.50), (58, 0.50, 1.0), (57, 1.0, 1.50),
              (58, 1.50, 2.0), (59, 2.0, 2.50), (60, 2.50, 3.0),
    ...
    evaluate("K=C@ 1♭1 𝄫1♭1 ♮1♯1 𝄪1♯1 | 1 - - - |",
             [(59, 0.0, 0.50), (58, 0.50, 1.0), (57, 1.0, 1.50),
              ...
              (61, 3.0, 3.50), (60, 3.50, 4.0), (59, 4.0, 8.0)],
             numeric=True)
    evaluate("K=c 7♭7 𝄫7♭7 ♮7♯7 𝄪7♯7 | 7 - - - |",
             [(58, 0.0, 0.50), (58, 0.50, 1.0), (57, 1.0, 1.50),
              (58, 1.50, 2.0), (59, 2.0, 2.50), (60, 2.50, 3.0),
              (61, 3.0, 3.50), (60, 3.50, 4.0), (58, 4.0, 8.0)],
             numeric=True)
