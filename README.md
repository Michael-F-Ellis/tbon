...
Here endeth the tutorial. The notation reference below contains the fine print and more illustrations of the concepts we've just covered plus some other considerations that include [tempo](#tempo), [volume](#velocity-loudness), [downbeat emphasis](#de-emphasis) and [MIDI Channel](#channel). The extended notation section explains how to write [chords](#chords) and [multiple voices](#multiple-voices). (tbon is quite capable of representing an entire symphony score).
